...
`however-microservices-lab` is the cloud-native integration slice. It proves that AI capability can be introduced into a multi-language Kubernetes microservices system while keeping local fallback, CI, and deployment paths visible.
